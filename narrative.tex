...
distributed about some most likely value $\theta_*$.
...
In a deterministic parameter estimation mode, given the parameters $\theta_\tau$ at step $\tau$,
...
The distributions for the coarsened processes are obtained as marginals of the original
