...
interstitial defect can combine to heal the crystal. 
  ...
  provide an overview of the building blocks of such a model.
  Detailed electronic structure calculations
    provide a wealth of information indicating
  the important physical processes and configuration effects \cite{Walsh2012}, but are
...
\begin{itemize}
  ...
  well established models are available. \MarginPar{at least CVD is,
    although co-evaporation is more common JBB: are parameters known}
