...
\begin{enumerate}
	...
	\item Find samples in this region by solving the random algebraic equations (\ref{eq:IS_sampling_eq})\
        \item Compute weight of the samples
\end{enumerate}
