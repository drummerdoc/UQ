...
attempt to fix this, I chose $50(10^3)$ samples randomly from the
...
$\begin{array}{c c}
\includegraphics[width=0.48\columnwidth]{figs/long_annealing/triangle_seq_prior_0.png}
& \includegraphics[width=0.48\columnwidth]{figs/long_annealing/triangle_seq_prior_spdf_0.png}
\\
n=0 & n=0 \\
\includegraphics[width=0.48\columnwidth]{figs/long_annealing/triangle_seq_prior_1.png}
& \includegraphics[width=0.48\columnwidth]{figs/long_annealing/triangle_seq_prior_spdf_1.png}
\\
n = 1 & n=1 \\
\includegraphics[width=0.48\columnwidth]{figs/long_annealing/triangle_seq_prior_2.png}
& \includegraphics[width=0.48\columnwidth]{figs/long_annealing/triangle_seq_prior_spdf_2.png} \\
n = 2 & n=2 \\
\end{array}$
