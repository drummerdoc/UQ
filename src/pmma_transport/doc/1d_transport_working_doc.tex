...
& \includegraphics[width=0.48\columnwidth]{figs/long_annealing_run_wrong_island/triangle_seq_prior_3.png}
\\
n = 2 & n=3 \\
\includegraphics[width=0.48\columnwidth]{figs/long_annealing_run_wrong_island/triangle_seq_prior_4.png}
& \includegraphics[width=0.48\columnwidth]{figs/long_annealing_run_wrong_island/triangle_seq_prior_5.png} \\
n = 4 & n=5 \\
\end{array}$
  \caption{Baseline starting walkers uniformly across bounds, using
    annealing process where $\sigma = \sigma_0*(1+98)e^{-(5/4) n}$,
