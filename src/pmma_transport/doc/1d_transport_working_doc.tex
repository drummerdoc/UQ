...
\begin{figure}
$\begin{array}{c c}
\includegraphics[width=0.4\columnwidth]{figs/reasonable_but_wrong/triangle_seq_prior_0.png}
& \includegraphics[width=0.4\columnwidth]{figs/reasonable_but_wrong/triangle_seq_prior_1.png}
\\
n=0 & n=1 \\
\includegraphics[width=0.4\columnwidth]{figs/reasonable_but_wrong/triangle_seq_prior_2.png}
& \includegraphics[width=0.4\columnwidth]{figs/reasonable_but_wrong/triangle_seq_prior_3.png}
\\
n = 2 & n=3 \\
\includegraphics[width=0.4\columnwidth]{figs/reasonable_but_wrong/triangle_seq_prior_4.png}
& \includegraphics[width=0.4\columnwidth]{figs/reasonable_but_wrong/triangle_seq_prior_5.png} \\
n = 4 & n=5 \\
\end{array}$
...
\text{Input samples}& \text{Uniform samples reweighted by histogram} \\
\end{array}$
