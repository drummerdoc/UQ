...
void CKINIT()
{
    ...
    R[0].fwd_Ea    = 0;
    R[0].low_A     = 2.3e+18;
    R[0].low_beta  = -0.90000000000000000;
    R[0].low_Ea    = -1700;
    R[0].troe_a    = 0.73460000000000000;
    R[0].troe_Tsss = 94;
    R[0].troe_Ts   = 1756;
    R[0].troe_Tss  = 5182;
    R[0].troe_len  = 4;
    ...
    R[1].fwd_beta  = -1;
    R[1].fwd_Ea    = 0;
    R[1].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[2].fwd_beta  = -1;
    R[2].fwd_Ea    = 0;
    R[2].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[3].fwd_beta  = -0.86;
    R[3].fwd_Ea    = 0;
    R[3].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[4].fwd_beta  = -1;
    R[4].fwd_Ea    = 0;
    R[4].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[5].fwd_beta  = -2;
    R[5].fwd_Ea    = 0;
    R[5].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[6].fwd_beta  = 2.67;
    R[6].fwd_Ea    = 6290;
    R[6].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[7].fwd_beta  = 0;
    R[7].fwd_Ea    = 0;
    R[7].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[8].fwd_beta  = 2;
    R[8].fwd_Ea    = 4000;
    R[8].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[9].fwd_beta  = -1.72;
    R[9].fwd_Ea    = 0;
    R[9].prefactor_units  = 1.0000000000000000e-12;
    R[9].activation_units = 0.50321666580471969;
    R[9].phase_units      = 1e-18;
    R[9].is_PD = 0;

    R[10].fwd_A     = 9.38e+18;
    R[10].fwd_beta  = -0.76000000000000000;
    R[10].fwd_Ea    = 0;
    R[10].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[11].fwd_beta  = -1.72;
    R[11].fwd_Ea    = 0;
    R[11].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[12].fwd_beta  = 0;
    R[12].fwd_Ea    = 14413;
    R[12].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[13].fwd_beta  = -0.60;
    R[13].fwd_Ea    = 0;
    R[13].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[14].fwd_beta  = -1.25;
    R[14].fwd_Ea    = 0;
    R[14].prefactor_units  = 1.0000000000000000e-12;
    ...
    R[15].fwd_beta  = 0;
    R[15].fwd_Ea    = 671;
    R[15].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[16].fwd_beta  = 0;
    R[16].fwd_Ea    = 1068;
    R[16].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[17].fwd_beta  = 0;
    R[17].fwd_Ea    = 635;
    R[17].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[18].fwd_beta  = 2;
    R[18].fwd_Ea    = 5200;
    R[18].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[19].fwd_beta  = 0;
    R[19].fwd_Ea    = 3600;
    R[19].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[20].fwd_beta  = 1.51;
    R[20].fwd_Ea    = 3430;
    R[20].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[21].fwd_beta  = 2.4;
    R[21].fwd_Ea    = -2110;
    R[21].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[22].fwd_beta  = 0;
    R[22].fwd_Ea    = -500;
    R[22].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[23].fwd_beta  = 0;
    R[23].fwd_Ea    = 320;
    R[23].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[24].fwd_beta  = 0;
    R[24].fwd_Ea    = 9560;
    R[24].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[25].fwd_beta  = 0;
    R[25].fwd_Ea    = -1630;
    R[25].prefactor_units  = 1.0000000000000000e-06;
    ...
    R[26].fwd_beta  = 0;
    R[26].fwd_Ea    = 12000;
    R[26].prefactor_units  = 1.0000000000000000e-06;
