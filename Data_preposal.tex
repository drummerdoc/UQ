...
%the  experiments.
%
Our ability to predict the behavior of these types of complex systems depends on our ability
to combine data and simulation within a framework that allows us to use the data
to improve the  predictive capability ov the model.
In particular, we want to use data in conjunction with simulation to quantify the range of model parameters
that
are consistent with the experimental data, combining results from multiple experiments
to improve predictions of overall system behavior.
